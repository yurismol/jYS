...
mSNPOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public = list(
        initialize = function(
            ...
            private$..freqPct <- jmvcore::OptionBool$new(
                ...
                freqPct,
                default=FALSE)
            private$..signifMarkers <- jmvcore::OptionBool$new(
                "signifMarkers",
                signifMarkers,
                default=FALSE)
            ...
            self$.addOption(private$..signifMarkers)
    ...
    active = list(
        ...
        signifMarkers = function() private$..signifMarkers$value,
                ...
                public=list(
                    initialize=function(options) {
                        ...
                        self$add(jmvcore::Table$new(
                            ...
                            title="Analysis of Alleles and Genotypes by Outcome Variable",
                            clearWith=list(
                                "vars",
                                "outcome",
                                "freqPct",
